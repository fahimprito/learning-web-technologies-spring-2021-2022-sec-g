...
<body>
    ...
    <center>
        <form  id="d1" action="../../controllers/notesUploadCheck.php" method="POST" enctype="multipart/form-data">
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit" name="upload" value="Upload" onclick= "notecheck()" >
                        </td>
                    </tr>
