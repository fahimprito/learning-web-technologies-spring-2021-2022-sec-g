...
<body>
    ...
    <table border="2" style="width: 100%; text-align: center;">
        ...
        <tr><td>Todays Class - Present</td></tr>
        <tr>
            <td style="width: 100%; padding: 20px;">

            <?php

    $file = fopen("../../models/attendance/$date._PresentList.txt", "r"); ?>
<html>
    <center>
        ...
        <table border="1" style="text-align: center;">
            <tr>
                ...
                <td style="width: 100px;">
                    <a style="color: rgb(150, 60, 255);"  href="#">Update</a>
                </td>
...
?>
    ...
    <table border="2" style="width: 100%; text-align: center;">
        ...
        <tr><td>Today's Class - Absent</td></tr>
        <tr>
            <td style="width: 100%; padding: 20px;">

            <?php

    $file = fopen("../../models/attendance/$date._AbsentList.txt", "r"); ?>
<html>
    <center>
    <table border="1" style="text-align: center;">
    <tr>
